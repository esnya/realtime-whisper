...
from ..config.gradio_config import GradioConfig
...
class GradioInterface(SpeechTranscriptionInterface):
...
if __name__ == "__main__":
    ...
    async def main():
        async with GradioInterface(
            config.gradio, config.transcription.sampling_rate
        ) as app:
